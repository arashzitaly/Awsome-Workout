...
import {firestoreErrorHandler, logger} from '@utility/helper/functionHelper';
...
export const updateProfile = (updatedProfileObj) => {
  return (dispatch, getState) => {
    return new Promise((resolve, reject) => {

      userQueries.update(updatedProfileObj.id, updatedProfileObj).then((response) => {
        if (response.result) {
          dispatch({
